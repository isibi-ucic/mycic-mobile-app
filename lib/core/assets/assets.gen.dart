...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/qr_presensi.png
  AssetGenImage get qrPresensi =>
      const AssetGenImage('assets/images/qr_presensi.png');

  /// List of all assets
  List<AssetGenImage> get values => [qrPresensi];
}

class $AssetsIconsMenuGen {
  const $AssetsIconsMenuGen();

  /// File path: assets/icons/menu/add_attendance.svg
  SvgGenImage get addAttendance =>
      const SvgGenImage('assets/icons/menu/add_attendance.svg');

  /// File path: assets/icons/menu/button_add.svg
  SvgGenImage get buttonAdd =>
      const SvgGenImage('assets/icons/menu/button_add.svg');
...
class $AssetsIconsNavGen {
  ...
  /// File path: assets/icons/nav/myclass.svg
  SvgGenImage get myclass => const SvgGenImage('assets/icons/nav/myclass.svg');

  /// File path: assets/icons/nav/scan.svg
  SvgGenImage get scan => const SvgGenImage('assets/icons/nav/scan.svg');

  /// List of all assets
  List<SvgGenImage> get values => [home, myclass, scan];
}

class $AssetsImagesMenuGen {
  const $AssetsImagesMenuGen();

  /// File path: assets/images/menu/informasi.png
  AssetGenImage get informasi =>
      const AssetGenImage('assets/images/menu/informasi.png');

  /// File path: assets/images/menu/jadwal.png
  AssetGenImage get jadwal =>
      const AssetGenImage('assets/images/menu/jadwal.png');

  /// File path: assets/images/menu/kelas.png
  AssetGenImage get kelas =>
      const AssetGenImage('assets/images/menu/kelas.png');

  /// File path: assets/images/menu/khs.png
  AssetGenImage get khs => const AssetGenImage('assets/images/menu/khs.png');

  /// File path: assets/images/menu/semua.png
  AssetGenImage get semua =>
      const AssetGenImage('assets/images/menu/semua.png');

  /// File path: assets/images/menu/skripsi.png
  AssetGenImage get skripsi =>
      const AssetGenImage('assets/images/menu/skripsi.png');

  /// File path: assets/images/menu/transkrip.png
  AssetGenImage get transkrip =>
      const AssetGenImage('assets/images/menu/transkrip.png');

  /// File path: assets/images/menu/ujian.png
  AssetGenImage get ujian =>
